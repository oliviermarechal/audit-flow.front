    ...
    <div class="vertical-center">
        <Block width="col-6">
            ...
            <form on:submit|preventDefault={handleRegistration} class="flex-column align-center">
                <Input fullWidth key="email" label="Email" color="text-light" name="email" bind:element={email} />
                <Input fullWidth key="password" label="Mot de passe" color="text-light" name="password" type="password" bind:element={password} />
